...
<div class="container-fluid bg-light" style="border: 2px solid #dee2e6; padding: 10px;">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
...
<footer class="pt-3 my-3 text-muted border-top text-center">Copyright &copy; <?= date('Y'); ?> | <a href="<?= urlFull(); ?>" class="text-decoration-none"><?= urlFull(); ?></a> | <a href="<?= urlFull(); ?>rss.php" class="text-decoration-none"><i class="fa-solid fa-square-rss" style="color: orange;"></i></a> <?= getValue("homepage_hide_login_link") != "1" ? "" : '| <a href="'.urlFull().'login.php" class="text-decoration-none"><i class="fas fa-sign-in-alt"></i></a>'; ?></footer>
...
<?php
if (!empty(getValue("bottom_link_1"))) { ?><p class="text-center"><?= getValue("bottom_link_1"); ?></p><?php } ?>
