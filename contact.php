	...
	<div class="d-flex justify-content-center" style="padding-bottom: 20px;">
	  <form class="w-50" method="post">
		...
		<div class="d-flex justify-content-center mb-3">
		  <div class="g-recaptcha" data-sitekey="<?= getValue("recaptcha2_site_key"); ?>" data-size="normal" data-theme="light"></div>
		</div>
		<div class="d-grid">
		  <button class="btn btn-primary btn-lg" id="submitContact" type="submit">
			<img src="<?= urlFull(); ?>images/img-loading.gif" alt="preloader" id="imgPreloader" style="display:none"> <i class="fas fa-envelope"></i> Send
		  </button>
		</div>
	  </form>
	</div>
	  ...
	  $("#submitContact").on('click', function(e) {
		...
		$.ajax({
		  ...
		  data: {
			...
			"g-recaptcha-response": response // add reCAPTCHA response to the data
		  },
